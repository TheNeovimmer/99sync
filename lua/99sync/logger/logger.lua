...
--- @type table<number, _99sync.Logger.RequestLogs>
local logger_cache = {}
local logger_list = {}
local max_requests_in_logger_cache = MAX_REQUEST_DEFAULT

--- @class _99sync.Logger.Options
--- @docs included
--- @field level number?
...
--- @class _99sync.Logger.RequestLogs
--- @field last_access number
--- @field logs string[]

--- @class _99sync.Logger
--- @field level number
...
--- @param opts _99sync.Logger.Options?
