--- @class _99sync.Providers.Observer
--- @field on_stdout fun(line: string): nil
--- @field on_stderr fun(line: string): nil
--- @field on_complete fun(status: _99sync.Prompt.EndingState, res: string): nil
...
--- @class _99sync.Providers.BaseProvider
--- @field _build_command fun(self: _99sync.Providers.BaseProvider, query: string, context: _99sync.Prompt): string[]
--- @field _get_provider_name fun(self: _99sync.Providers.BaseProvider): string
...
function BaseProvider:make_request(query, context, observer)
  ...
  local extra_args = context._99sync and context._99sync.provider_extra_args or {}
...
--- @class OpenCodeProvider : _99sync.Providers.BaseProvider
...
--- @class ClaudeCodeProvider : _99sync.Providers.BaseProvider
...
--- @class CursorAgentProvider : _99sync.Providers.BaseProvider
...
--- @class KiroProvider : _99sync.Providers.BaseProvider
...
--- @class GeminiCLIProvider : _99sync.Providers.BaseProvider
...
function GeminiCLIProvider._get_default_model()
  -- Latest stable as of Sep 2026. `auto` also works for auto-routing, see:
