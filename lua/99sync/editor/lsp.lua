local Geo = require("99sync.geo")
local ts = require("99sync.editor.treesitter")
--- @class Lsp
--- @field config _99sync.Options Configuration options for the LSP client
local Lsp = {}
Lsp.__index = Lsp
...
--- @field range _99sync.Range The range in the target document where the definition is located
...
--- @param position _99sync.Point The position in the document to get definitions for
...
--- @class _99sync.lsp.ExportPosition
--- @field name string
--- @field line number
--- @field col number

--- @class _99sync.lsp.ExportMember
--- @field name string
--- @field line number
--- @field col number
--- @field kind number|nil

--- @class _99sync.lsp.ExportMetadata
--- @field kind number|nil
--- @field members _99sync.lsp.ExportMember[]|nil

--- @alias _99sync.lsp.ExportMeta table<string, _99sync.lsp.ExportMetadata>

--- Extracts export keys and metadata from LSP document symbols.
---
--- @param symbols table|nil LSP document symbols
--- @return _99sync.lsp.ExportPosition[] export_keys
--- @return _99sync.lsp.ExportMeta export_meta
...
--- @param position _99sync.Point The position to resolve
...
---
--- @param config _99sync.Options The configuration options
...
--- @param position _99sync.Point The position of the import path or symbol
...
---
--- @param source_bufnr number The buffer number containing the reference
--- @param node _99sync.treesitter.Node The treesitter node pointing at the import path or symbol
--- @param cb fun(result: string, err: string|nil): nil Callback with formatted string or error
