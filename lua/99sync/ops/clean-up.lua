...
--- @alias _99sync.Providers.on_complete fun(status: _99sync.Prompt.EndingState, response: string): nil
--- @class _99sync.Providers.PartialObserver
--- @field on_complete _99sync.Providers.on_complete
--- @field on_stdout? fun(line: string): nil
--- @field on_stderr? fun(line: string): nil
--- @field on_start? fun(): nil

--- @param context _99sync.Prompt
--- @param obs_or_fn _99sync.Providers.PartialObserver | _99sync.Providers.on_complete
--- @return _99sync.Providers.Observer
M.make_observer = function(context, obs_or_fn)
  --- @type _99sync.Providers.PartialObserver
