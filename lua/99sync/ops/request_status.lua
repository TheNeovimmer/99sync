...
--- @class _99sync.RequestStatus
--- @field update_time number the milliseconds per update to the virtual text
--- @field status_line _99sync.StatusLine
--- @field lines string[]
--- @field max_lines number
--- @field running boolean
--- @field mark? _99sync.Mark
...
--- @param title_line string
--- @param mark_or_fn _99sync.Mark | fun(status: string[]): nil
--- @return _99sync.RequestStatus
