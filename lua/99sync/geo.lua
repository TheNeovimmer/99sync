...
--- @param point_or_row _99sync.Point | number
...
--- @class _99sync.Range
--- @field start _99sync.Point
--- @field end_ _99sync.Point
--- @field buffer number
local Range = {}
Range.__index = Range

---@param buffer number
--- @param start _99sync.Point
---@param end_ _99sync.Point
...
---@param node _99sync.treesitter.Node
---@param buffer number
---@return _99sync.Range
...
---@param start _99sync.Mark
---@param end_ _99sync.Mark
---@return _99sync.Range
